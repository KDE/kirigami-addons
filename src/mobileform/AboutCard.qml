...
/**
 * @brief An Form Card that displays the about data
 *
...
FormCard {
    ...
    contentItem: ColumnLayout {
        ...
        FormDelegateSeparator { above: generalDelegate; below: copyrightDelegate }
        ...
        FormDelegateSeparator { above: copyrightDelegate; below: getInvolvedDelegate }
        ...
        FormDelegateSeparator { above: getInvolvedDelegate; below: donateDelegate }
        ...
        FormDelegateSeparator { above: donateDelegate; below: homepageDelegate }
        ...
        FormDelegateSeparator { above: homepageDelegate; below: bugDelegate }
        ...
        FormSectionText {
            Layout.fillWidth: true
            text: i18ndp("kirigami-addons", "Licenses", "License", aboutData.licenses.length)
        }
        ...
        FormSectionText {
            text: i18nd("kirigami-addons", "Libraries in use")
        ...
        Repeater {
            ...
            delegate: FormTextDelegate {
                Layout.fillWidth: true
                text: modelData.name
                description: modelData.version === "" ? "" : modelData.version
            }
        }
        ...
        FormSectionText {
            text: i18nd("kirigami-addons", "Authors")
            visible: aboutData.authors.length > 0
            Layout.fillWidth: true
        }
        ...
        FormSectionText {
            text: i18nd("kirigami-addons", "Credits")
            visible: aboutData.credits.length > 0
            Layout.fillWidth: true
        }
        ...
        FormSectionText {
            text: i18nd("kirigami-addons", "Translators")
            visible: aboutData.translators.length > 0
            Layout.fillWidth: true
        }
