...
class KirigamiGuiItem;
class KirigamiToggleActionPrivate;

/**
 *  @class KirigamiToggleAction ktoggleaction.h KirigamiToggleAction
 *
 ...
 *
 */
class KIRIGAMIADDONSBASEAPP_EXPORT KirigamiToggleAction : public QAction
{
    Q_OBJECT
...
public:
     ...
     */
    explicit KirigamiToggleAction(QObject *parent);
     ...
     * @param parent The action's parent object.
     */
    KirigamiToggleAction(const QString &text, QObject *parent);
     ...
     * @param parent The action's parent object.
     */
    KirigamiToggleAction(const QIcon &icon, const QString &text, QObject *parent);

    /**
     * Destructor
     */
    ~KirigamiToggleAction() override;
     ...
     */
    void setCheckedState(const KirigamiGuiItem &checkedItem);

protected Q_SLOTS:
    virtual void slotToggled(bool checked);

protected:
    KIRIGAMIADDONSBASEAPP_NO_EXPORT KirigamiToggleAction(KirigamiToggleActionPrivate &dd, QObject *parent);

protected:
    std::unique_ptr<class KirigamiToggleActionPrivate> const d_ptr;

private:
    Q_DECLARE_PRIVATE(KirigamiToggleAction)
};
